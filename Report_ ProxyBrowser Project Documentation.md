...
2. ### Proxy-Browser-Backend
    ...
    - **Attribute Knowledge**
      - **Users**
        ...
        - **Associations**
          -  Users **one-to-many** OTP
          -  Users **one-to-many** PaymentMethods
          -  Users **one-to-many** Plans
       ...
       - **Locations**
         ...
         | location | Valid Proxy Location  | A proxy Location |
          ...
          - **Associations**
            -  Locations **many-to-one** Users
            -  Locations **one-to-one** Sessions
              
       - **OTP**
         | Attribute Name | Possible Values | Description |
         | ------------ | ------------ | ------------ |
         | code | Any 4 character alphanumber String  | A code to be entered by user to reset password |
         | creation_timestamp | Timestamp | A timestamp when code was created |
         | expiry_timestamp | Timestamp  | A timestamp when code will be expired |
